...
const BOTNAME = 'SULTAN-MD|-WA-BOT™';
const FOOTERNAME = '> SULTAN -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '+3584573984290' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || ' VAJIRA-MD=fBdWybwD#2vSqqhTtST1AW8Fwau1RsO6V66iiKK8BqwSEVLfNQqw' ,
...
FOOTER: process.env.FOOTER || '‌👨‍💻 SULTAN -  ＭＤ - Ｖ5 👨‍💻',    
